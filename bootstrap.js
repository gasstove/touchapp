...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.ux.field.DateTimePicker": "ux/DateTimePicker.js",
  "Ext.ux.parse": "touch/src/ux/parse",
  "Ext.ux.picker.DateTime": "ux/DateTime.js",
  "touchapp": "app"
});
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "touchapp.controller.EditGuestList": [],
  "touchapp.controller.EventConfig": [],
  "touchapp.controller.EventsList": [],
  "touchapp.controller.Login": [],
  "touchapp.controller.Navigation": [],
  "touchapp.controller.UserProfile": [],
  "touchapp.model.Event": [],
  "touchapp.model.Media": [],
  "touchapp.model.User": [],
  "touchapp.store.Contacts": [],
  "touchapp.store.Event": [],
  "touchapp.store.EventUsers": [],
  "touchapp.store.EventsList": [],
  "touchapp.store.MyMedias": [],
  "touchapp.store.SharedMedias": [],
  "touchapp.view.EventConfigBase": [],
  "touchapp.view.Login": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "touchapp.view.event.DebugMyMedia": [
    "widget.myMediaViewDebug"
  ],
  "touchapp.view.event.DebugSharedMedia": [
    "widget.sharedMediaViewDebug"
  ],
  "touchapp.view.event.EditGuestList": [
    "widget.editguestlist"
  ],
  "touchapp.view.event.EventConfig": [
    "widget.eventconfig"
  ],
  ...
  "touchapp.view.event.EventUsersPanel": [
    "widget.eventusersPanel"
  ],
  "touchapp.view.event.MyMedia": [
    "widget.myMediaView"
  ],
  "touchapp.view.event.SharedMedia": [
    "widget.sharedMediaView"
  ],
  "touchapp.view.user.EventsList": [
    "widget.eventslist"
  ],
